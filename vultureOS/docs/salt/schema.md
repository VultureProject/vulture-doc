...
```
    ...
    lockself_x_ls_token: str
    lockself_x_auth_token: str
    lockself_host: str
    lockself_organization_id: str
    cisco_umbrella_managed_org_api_key: str
    cisco_umbrella_managed_org_secret_key: str
    cisco_umbrella_managed_org_customers_id: list
    cisco_umbrella_managed_org_get_dns: bool
    cisco_umbrella_managed_org_get_proxy: bool
    catonetworks_api_key: str
    catonetworks_account_id: str
    catonetworks_marker: str
    infoblox_threat_defense_host: str
    infoblox_threat_defense_token: str
    beyondtrust_reportings_client_id: str
    beyondtrust_reportings_secret: str
    beyondtrust_reportings_host: str
    beyondtrust_reportings_get_team_logs: bool
    beyondtrust_reportings_get_access_session_logs: bool
    beyondtrust_reportings_get_vault_account_activity_logs: bool
    beyondtrust_reportings_get_support_session_logs: bool
    varonis_host: str
    varonis_api_key: str
    armis_centrix_host: str
    armis_centrix_secretkey: str
    armis_centrix_get_activity_logs: bool
    perception_point_x_ray_host: str
    perception_point_x_ray_token: str
    extrahop_host: str
    extrahop_id: str
    extrahop_secret: str
    hornetsecurity_app_id: str
    hornetsecurity_token: str
    ubika_base_refresh_token: str
    ubika_namespaces: list
    sentinel_one_identity_graph_token: str
    sentinel_one_identity_graph_console_url: str
```
</details>
